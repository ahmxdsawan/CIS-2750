...
header = """<svg version="1.1" width="1500" height="1500" xmlns="http://www.w3.org/2000/svg">"""
...
class Molecule(molecule.molecule):
    ...
    def parse(self, sdf):
        ...
        for i in range(num_atoms):
            line = sdf.readline().decode() # let line equal the string line
        ...
        for i in range(num_bonds):
            ...
            line = sdf.readline() # let the line equate to a string 
            a1, a2, bond_type = map(int, line.split()[:3]) # then use the map function the append everything into their apprioriate vatiables
            self.append_bond(a1, a2, bond_type) # finally append the attrubutes of a bond using append_bond
...
#     with open("cocaine-3D-structure-CT1002384854.sdf", "rb") as f:
#         mol = Molecule()
#         mol.parse(f)
#         svg_str = mol.svg()
